...
In the implementation of Uni-ControlNet considered here, the Text-to-Image model Stable Diffusion[^2] is used, although the same methods are applicable to other diffusion models.
...
They were first introduced in 2015 but have only become established in the last three years.
...
<p align="center">
    ...
    <br>
    <sup>The rough number of papers on diffusion models per year[^4]</sup>
</p>
...
Gaussian noise is a kind of signal noise that has a probability density function equal to that of the normal distribution.[]
