...
<figcaption>A red LaFerrari is driving towards the camera.</figcaption>

![Image of LaFerrari 2](/images/laferrari_image_2.jpeg){: .align-left width="200px"}
<figcaption>A red LaFerrari is driving towards the camera. The car is driving on a racetrack and is taking a left turn.</figcaption>

![Image of LaFerrari 3](/images/laferrari_image_3.jpeg){: .align-left width="200px"}
<figcaption>A red LaFerrari is driving towards the camera. The car is driving on a racetrack and is taking a left turn. 
...
| A red LaFerrari is driving towards the camera. | A red LaFerrari is driving towards the camera. The car is driving on a racetrack and is taking a left turn. | A red LaFerrari is driving towards the camera. The car is driving on a racetrack and is taking a left turn. 
...
Uni-ControlNet is a framework that allows the utilization of different conditions beyond text descriptions.
