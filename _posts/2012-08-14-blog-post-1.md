...
<p align="justify">
Alongside chatbots, the most frequently used generative AI applications are Text-to-Image models like DALL-E[^1]<a href="#source1">[1]</a>, or Stable Diffusion[^2]<a href="#source2">[2]</a>.
These are able to generate realistic and detailed images using textual instructions given by the user.
</p>

In this blog post, I intend to explain a common weakness of Text-to-Image generation models and explore one possible solution following the introduction of Uni-ControlNet[^3]<a href="#source3">[3]</a>.
...
These embeddings are extracted using a tool called CLIP[^7]<a href="#source7">[7]</a>.
...
These are ControlNet[^8]<a href="#source8">[8]</a>, GLIGEN[^9]<a href="#source9">[9]</a> and T2I-Adapter[^10]<a href="#source10">[10]</a>.  
...
For this comparison, we use the *Structural Similarity Index Measure (SSIM)*[^11]<a href="#source11">[11]</a>.
...
We therefore compare Uni-ControlNet to the frameworks mentioned above and, additionally another state-of-the-art control framework, Composer[^12]<a href="#source12">[12]</a>.
