...
A typical Diffusion Model consists of an Encoder, a Middle Block und a Decoder.
...
The global control adapter also enables the user to control how strong the reference image influences the generated image.
This is implemented with a hyper-parameter lambda ʎ that controls the weight of the global condition.
This parameter cant take values from 0.5, where the global condition is not taken into account, to 1.0 where the text prompt is not used and the image only depends on the global condition.
...
These are ControlNet[^7], GLIGEN[^8] and T2I-Adapter[^9].
...
[^7]: [ControlNet](https://arxiv.org/pdf/2302.05543)
[^8]: [GLIGEN](https://gligen.github.io/)
[^9]: [T2I-Adapter](https://arxiv.org/pdf/2302.08453)

[^10]: [Composer](https://arxiv.org/pdf/2302.09778)
