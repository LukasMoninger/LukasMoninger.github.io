...
<p align="justify">
Alongside chatbots, the most frequently used generative AI applications are Text-to-Image models like DALL-E[^1]<a href="#quelle1">[1]</a>, or Stable Diffusion[^2].
...
They were first introduced in 2015 but have only been established in the last three years[^4].
...
Therefore, we project the text into a high-dimensional latent space and take the position of our text as a vector.[^6]
...
<ol>
    <li id="source1">Beispielbuch, Autor Name, Jahr <a href="https://www.beispielseite.de" target="_blank">Beispielseite</a></li>
    <li id="source2">Beispielbuch, Autor Name, Jahr <a href="https://www.beispielseite.de" target="_blank">Beispielseite</a></li>
    <li id="source3">Beispielbuch, Autor Name, Jahr <a href="https://www.beispielseite.de" target="_blank">Beispielseite</a></li>
    <li id="source4">Beispielbuch, Autor Name, Jahr <a href="https://www.beispielseite.de" target="_blank">Beispielseite</a></li>
    <li id="source5">Beispielbuch, Autor Name, Jahr <a href="https://www.beispielseite.de" target="_blank">Beispielseite</a></li>
    <li id="source6">Beispielbuch, Autor Name, Jahr <a href="https://www.beispielseite.de" target="_blank">Beispielseite</a></li>
    <li id="source7">Beispielbuch, Autor Name, Jahr <a href="https://www.beispielseite.de" target="_blank">Beispielseite</a></li>
    <li id="source8">Beispielbuch, Autor Name, Jahr <a href="https://www.beispielseite.de" target="_blank">Beispielseite</a></li>
    <li id="source9">Beispielbuch, Autor Name, Jahr <a href="https://www.beispielseite.de" target="_blank">Beispielseite</a></li>
    <li id="source10">Beispielbuch, Autor Name, Jahr <a href="https://www.beispielseite.de" target="_blank">Beispielseite</a></li>
    <li id="source11">Beispielbuch, Autor Name, Jahr <a href="https://www.beispielseite.de" target="_blank">Beispielseite</a></li>
    <li id="source12">Beispielbuch, Autor Name, Jahr <a href="https://www.beispielseite.de" target="_blank">Beispielseite</a></li>
</ol>
