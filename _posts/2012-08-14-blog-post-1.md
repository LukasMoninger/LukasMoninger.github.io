...
The *Local Control Adapter* also uses the local conditions to produce an output that is combined with the output from the diffusion encoder.<br>
...
CLIP stands for *Contrastive Language-Image Pre-training* and is an image encoder developed by OpenAI.<br>
...
After this, a feature extractor is used to extract all features and important information from the conditions.<br>
