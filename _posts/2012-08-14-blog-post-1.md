...
Let's take a closer look at how these two adapters work.
...
This doesn't produce good results for all combinations of local conditions because they may be contradictory.
The first example shows the combination of the two local conditions Openpose and segmentation mask.
In the seconds example you can see two contradictory conditions.
In other cases one of the two contradictory conditions is completely ignored.

![Composition of conditions 1](/images/composition_of_conditions_1.png){: .align-center width="700px"}
![Composition of conditions 2](/images/composition_of_conditions_2.png){: .align-center width="700px"}
...
[^11]: [Composer](https://arxiv.org/pdf/2302.09778)
